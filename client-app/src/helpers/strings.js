...
export const FacultyString = 'Faculty';
...
export const AllFacultyAdminsString = 'All faculty admins';
export const CreateNewFacultyString = 'Create new faculity';
export const CreateNewFacultyAdminString = 'Create new faculity admin';
...
export const PhotoString = 'Photo';
...
export const FacultyAdminCreateString = 'Create Faculty Admin';
export const chooseFaculty = 'Choose faculty';
